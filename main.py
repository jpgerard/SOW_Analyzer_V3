...
def main():
    ...
    from document_processing.advanced_extractor import AdvancedDocumentExtractor
    from analysis.section_extractor import extract_toc, EnhancedSectionExtractor
    from extraction.requirement_extractor import RequirementExtractor
    from reporting.proposal_matcher import HybridProposalMatcher
